...
RPS=$( ab -c 100 -n 10000 -T 'application/json' -H 'Accept: application/json' -p user.json http://127.0.0.1:"${NODE_PORT}"/api/auth/login | grep "Requests per second:" | grep -o -E "[0-9.]+" )
rm ./user.json
